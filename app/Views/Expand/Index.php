...
function metreturn(url){
	...
	<div class="position">简体中文 > 优化推广 > <a href="expand_link.html">友情链接</a></div>
...
<h3 class="v52fmbx_hr">
	<span class="formleft">
		<a href="expand_link_add.html" title="新增">+新增</a>
	</span>
...
<table cellpadding="2" cellspacing="1" class="table">
              ...
              <tr>
                ...
                <td class="list-text"><a href="index.php/admin/expand_link/doset?act=nostatus&id=14&&nat=0&page=1"><img src="statics/base/images/ok_1.gif"></a></td>      
				<td class="list-text">
                ...
                <td class="list-text"><a href="index.php/admin/expand_link/doset?act=nostatus&id=13&&nat=0&page=1"><img src="statics/base/images/ok_1.gif"></a></td>      
				<td class="list-text">
				<a href="expand_link_edit.html">编辑</a>
                ...
                <td class="list-text"><a href="index.php/admin/expand_link/doset?act=nostatus&id=12&&nat=0&page=1"><img src="statics/base/images/ok_1.gif"></a></td>      
				<td class="list-text">
				<a href="expand_link_edit.html">编辑</a>
				...
				<td class="list-text"><span>否</span></td>
				<td class="list-text">1</td>
                <td class="list-text"><a href="index.php/admin/expand_link/doset?act=nostatus&id=9&&nat=0&page=1"><img src="statics/base/images/ok_1.gif"></a></td>      
				<td class="list-text">
				<a href="expand_link_edit.html">编辑</a>
