	...
	<form action="" method="post" class="form form-horizontal" id="form-nav-add">
		...
		<div id="tab-category" class="HuiTab">
			...
			<div class="tabCon">
                ...
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>显示区域：</label>
                    <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                        <div class="radio-box">
                            <input type="radio" id="region" value="0" name="region" >
                            <label for="video-type-1">左侧</label>
                        </div>
                        <div class="radio-box">
                            <input type="radio" id="video-type-0" value="1" name="region">
                            <label for="video-type-0">主区域</label>
                        </div>
                        <div class="radio-box">
                            <input type="radio" id="video-type-0" value="2" name="region">
                            <label for="video-type-0">右侧</label>
                        </div>
                    </div>
                </div>
        ...
        submitHandler:function(form){
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    setTimeout(function(){
                        parent.location.replace('/system/nav');
