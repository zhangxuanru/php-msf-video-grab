...
<div class="page-container">
  <div class="text-c">
    视频类别:<span class="select-box inline">
      ...
      &nbsp;&nbsp;<span class="select-box inline" id="subClass" style="display: none">
   ...
   var classId = $('#catData').val();
    $.ajax({
        ...
        success: function (data) {
            ...
            $("#catSubData").append("<option value='0'>--全部--</option>");
...
function refreshDataTable() {
    ...
    var classId  = $("#catSubData").val();
    var classPid = $("#catData").val();
    var videoType = $("#videoType").val();
    if(video_title.length > 0 ){
        queryStr+="&title="+video_title;
    }
    if(classPid.length > 0 ){
        queryStr+="&classPid="+classPid;
    }
    if(classId.length > 0 ){
